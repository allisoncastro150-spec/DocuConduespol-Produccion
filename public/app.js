...
async function api(path, options = {}) {
    ...
    if (!response.ok) {
        ...
        error.duplicated = data.duplicated;
        error.document = data.document;
...
function showDuplicate(document){
...
function fillDepartments() {
    ...
    console.log("uploadDepartment", $("#uploadDepartment"));
    console.log("departmentText", $("#departmentText"));
    console.log("searchDepartment", $("#searchDepartment"));
    console.log("newUserDepartment", $("#newUserDepartment"));
    ...
    if (state.user.role === "admin") {
        ...
        uploadDepartment.classList.remove("hidden");
        $("#departmentText").classList.add("hidden");

    } else {

        uploadDepartment.value = state.user.department;
        uploadDepartment.classList.add("hidden");
        $("#departmentText").classList.remove("hidden");
        $("#departmentText").value = state.user.department;
...
async function refreshAudit(){
    ...
    console.log("Entrando a refreshAudit");
    ...
    $("#auditTable").innerHTML = `
        ...
        ${logs.map(log=>`
            ...
            <div class="row">
                ...
                <span>${log.details?.descripcion}</span>

                <span>${log.details?.ip}</span>
...
$$(".nav-item").forEach((button) => {
  button.addEventListener("click", async () => {
    ...
    if (button.dataset.view === "audit")await refreshAudit();
  });
});
